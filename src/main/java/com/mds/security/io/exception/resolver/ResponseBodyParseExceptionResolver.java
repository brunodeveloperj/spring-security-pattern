...
/**
 * {@link ExceptionResolver} for {@link ResponseBodyParseException}.
 *
 ...
 */
@Component
public class ResponseBodyParseExceptionResolver implements ExceptionResolver<ResponseBodyParseException> {

  /**
   * Resolves the given {@link ResponseBodyParseException} into an {@link ErrorResponse}.
   *
   * @param error the exception to resolve
   * @return an {@link ErrorResponse} with HTTP 500 status
   */
  @Override
  public ErrorResponse resolve(ResponseBodyParseException error) {
