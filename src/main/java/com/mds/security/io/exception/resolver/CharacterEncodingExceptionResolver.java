...
/**
 * {@link ExceptionResolver} for {@link CharacterEncodingException}.
 *
 ...
 */
@Component
public class CharacterEncodingExceptionResolver implements ExceptionResolver<CharacterEncodingException> {


  /**
   * Resolves the given {@link CharacterEncodingException} into an {@link ErrorResponse}.
   *
   * @param error the exception to resolve
   * @return an {@link ErrorResponse} with HTTP 500 status
   */
  @Override
  public ErrorResponse resolve(CharacterEncodingException error) {
